...
class Profile(models.Model):
    ...
    province_of_birth = models.CharField(max_length=100, blank=True)
...
class CityOfBirth(models.Model):
    name = models.CharField(max_length=100)
    province_of_birth = models.ForeignKey('ProvinceOfBirth', on_delete=models.CASCADE)

    def __str__(self):
        return f'{self.name} - {self.province_of_birth}'
